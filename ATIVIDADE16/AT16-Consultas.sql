...
select max(Salario)
from funcionarios
where DataNasci < 1985 and Cpf is not null;
...
-- 12. Selecione o número de funcionários que têm "Almeida" como parte do nome do funcionrio OU têm salário inferior a 3500.
select count(codigo)
from funcionarios
where SegundoNome = "Almeida" and UltimoNome = "Alemeida" or Salario < 3500.00;
...
select sum(Salario)
from funcionarios
where funcao = "Analista" or Salaraio >= 4000.00;
